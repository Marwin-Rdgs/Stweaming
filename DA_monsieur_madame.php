...
$requeteSQL = 'SELECT * FROM da_monsieurs_madames WHERE id_monsieurs_madames = ?';
...
<head>
    ...
    <title>Stweaming ~ Monsieurs Madames Saison <?php
    if ($dtr["id_monsieurs_madames"] >= 53) {
        echo "2"; }
        else {
        echo "1";
        } ?> EP <?php if ($dtr["id_monsieurs_madames"] >= 53) {
          echo $dtr["id_monsieurs_madames"] - 52;}
          else { 
            echo $dtr["id_monsieurs_madames"];}
         ?></title>
</head>
...
<div class="top_page">
<h1 class="page__title">Monsieurs, Madames <br>Saison <?php
    if ($dtr["id_monsieurs_madames"] >= 53) {
        echo "2"; }
        else {
        echo "1";
        } ?> Épisode <?php if ($dtr["id_monsieurs_madames"] >= 53) {
          echo $dtr["id_monsieurs_madames"] - 52;}
          else { 
            echo $dtr["id_monsieurs_madames"];}
         ?></h1>
...
<?= $dtr["ep_monsieurs_madames"] ?>
    
<?= $dtr["back_monsieurs_madames"] ?>
<?= $dtr["next_monsieurs_madames"] ?>
...
<table class="table table-hover list_episode" x-data="{S1: 1}">
  ...
  <tbody x-show="S1">
    ...
    <?php 
    if ($dtr["id_monsieurs_madames"] == 1) {
    echo "episode_here";
    }
    ?>">
    <th scope="row"> <a href="DA_monsieur_madame.php?id=1"> Les Monsieurs, Madames Saison 1 Episode 1 - Voler </a> </th>
    </tr>


    <tr class="
    <?php 
    if ($dtr["id_monsieurs_madames"] == 2) {
    echo "episode_here";
    }
    else {
    ...
    ?>">
      <th scope="row"><a href="DA_monsieur_madame.php?id=2"> Les Monsieurs, Madames Saison 1 Episode 2 - La Musique </a></th>
    </tr>


    <tr class="table-active 
    <?php 
    if ($dtr["id_monsieurs_madames"] == 3) {
    echo "episode_here";
    }
    ?>">
      <th scope="row"><a href="DA_monsieur_madame.php?id=3"> Les Monsieurs, Madames Saison 1 Episode 3 - Sport </a></th>
    </tr>


    <tr class="
    <?php 
    if ($dtr["id_monsieurs_madames"] == 4) {
    echo "episode_here";
    }
    else {
      echo "table-secondary";
